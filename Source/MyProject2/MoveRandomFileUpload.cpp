...
#include "MoveRandomFileUpload.h"

// Sets default values
AMoveRandomFileUpload::AMoveRandomFileUpload()
{
...
void AMoveRandomFileUpload::BeginPlay()
{
	Super::BeginPlay();
	int fileInfo = 0;
	gDirection = 1;
	...
	//FileName = "C:/Users/ypatotsk/Dev/UE5/data/sampleEntropy.txt";
...
// Called every frame
void AMoveRandomFileUpload::Tick(float DeltaTime)
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 1.0, FColor::Red, FString::Printf(TEXT("DeltaTime : %i"), DeltaTime));
